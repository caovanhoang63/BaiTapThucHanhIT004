...
VALUES
('0456','Cao Van Hoang','0896374872','1960-10-22'),
('0457','Cao Van Hoang','0896374872','1960-10-22'),
('0458','Cao Van Hoang','0896374872','1960-10-22'),
('0459','Cao Van Hoang','0896374872','1960-10-22'),
('0460','Cao Van Hoang','0896374872','1960-10-22');

DELETE FROM NHANVIEN WHERE HOTEN = 'Cao Van Hoang';

ALTER TABLE NHANVIEN
ALTER COLUMN NGVL SMALLDATETIME;
...
--Bai 6
-- Tao mot quan he moi co ten LOAIKHACHHOANG
-- Co cac thuoc tinh la MALOAIKH (TINYINT), TENLOAIKH (VARCHAR(20))
-- Ta tao FOREIN KEY trong bang FK_KHACHHANG_LOAIKHACHHANG THAM CHIEU DEN MALOAIKH
